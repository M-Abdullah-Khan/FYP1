                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                            <div class="container" id="nav_category_images"><!-- Navbar-Categories --><!--
                                --><div class="row"><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="electronics_appliances.php"><!--
                                            --><span style="align:center;">Electronics and Appliances<img src="other/appliances-150.jpg" id="EAP"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="cars_vehicles.php"><!--
                                            --><span style="align:center;">Cars and Vehicles<img src="other/cars-150.jpg" id="CV"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="sports_hobbies.php"><!--
                                            --><span style="align:center;">Sports and Hobbies<img src="other/Sports-150.jpg" id="SH"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="services.php"><!--
                                            --><span style="align:center;">Services<img src="other/services-150.jpg" id="Ser"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="mobiles.php"><!--
                                            --><span style="align:center;">Mobiles<img src="other/mobiles-150.jpg" id="Mob"></span><!--
                                        --></a><!--
                                    --></div><!--
                                --></div><!--
                                --><div class="row"><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="fashion.php"><!--
                                            --><span style="align:center;">Clothing and Fashion<img src="other/fashion-150.jpg" id="CF"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="jobs.php"><!--
                                            --><span style="align:center;">Jobs<img src="other/jobs-150.jpg" id="Job"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="lap_computers.php"><!--
                                            --><span style="align:center;">Laptops and Computers<img src="other/sub-categories/laptops-computers-150.jpg" id="LC"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="bikes.php"><!--
                                            --><span style="align:center;">Bikes<img src="other/bike-150.jpg" id="Bik"></span><!--
                                        --></a><!--
                                    --></div><!--
                                    --><div class="col-xs-2"><!--
                                        --><a href="books.php"><!--
                                            --><span style="align:center;">Books<img src="other/books-150.png" id="Boo"></span><!--
                                        --></a><!--
                                    --></div><!--
                                --></div><!--
                            --></div><!--
