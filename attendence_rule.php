...
<!-- NAV -->
	...
	<div class = "container">
		<div style="width:100%;">
			<div style="float: left; width: 30%"> 
 		   			...
 		   			<button class = "btn btn-lg btn-primary btn-block" type = "submit" name = "Live_View" id = "lvb">Live View</button>
				
			</div>
			<div style="float: right; width: 60%"> 
   		 		 
   		 		<button class = "btn btn-lg btn-primary btn-block" type = "submit" name = "User_Management" id = "amb">USER Management</button>
    ...
    <div class = "container">
        <h3 align="center">Admin Options</h3></br>
        <div style="float: left; width: 60%"> 
 		   		<div style="float: left; width: 40%">
 		   			<button class = "btn btn-lg btn-primary btn-block" type = "submit" name = "maintainence_options" id = "main_opt">Maintainence Options</button>
				</div>
				<div style="float: right; width: 40%"> 
   	 				<button class = "btn btn-lg btn-primary btn-block" type = "submit" name = "Handle_Attendence" id = "hand_atn">Handle Attendence</button>
				</div>
